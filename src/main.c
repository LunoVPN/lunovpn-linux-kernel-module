 ...
 * Copyright (C) 2024 LunoVPN. All Rights Reserved.
 */
...
static int __init wg_mod_init(void)
{
	...
	pr_info("LunoVPN " WIREGUARD_VERSION " loaded.\n");
	pr_info("Copyright (C) 2015-2019 Jason A. Donenfeld <Jason@zx2c4.com>. All Rights Reserved.\n");
	pr_info("Copyright (C) 2024-2025 LunoVPN. All Rights Reserved.\n");
...
MODULE_DESCRIPTION("LunoVPN secure network tunnel");
MODULE_AUTHOR("Jason A. Donenfeld <Jason@zx2c4.com>, LunoVPN");
